local M = {}
local g = vim.g
local opts = require("kwconfig").base46
...
M.toggle_theme = function()
    ...
    require("kawaii.utils").replace_word('theme = "' .. old_theme, 'theme = "' .. opts.theme)
...
M.toggle_transparency = function()
    ...
    require("kawaii.utils").replace_word("transparency = " .. tostring(old), new)
end
